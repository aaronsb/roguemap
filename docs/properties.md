...
| lsystem | table | {} | species | Parameter overrides for the habit, or a grammar written out in full: `branch_angle`, `forks`, `taper`, `droop`, `leaf_density`, `asymmetry`, `jitter`, `prune_height`, `dead_whorls`, `depth`, `length`, `leaf_radius`, `leaf_flat`, `axiom`, `rules`, `dead_rules` (docs/lsystem.md). |
